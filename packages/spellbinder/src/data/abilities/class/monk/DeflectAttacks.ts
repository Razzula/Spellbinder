...
const deflectAttacks: Ability = {
    ...
    description: {
        ...
        body: [
            'When an attack roll hits you including Bludgeoning, Piercing, or Slashing damage, you can take a Reaction to reduce the attack\'s total damage against you by 1d10 plus your Dexterity modifier and Monk level.',
